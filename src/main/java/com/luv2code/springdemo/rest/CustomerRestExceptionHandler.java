...
public class CustomerRestExceptionHandler {
	...
	// add ad excetion handler for customer not found exception
	
	@ExceptionHandler
	public ResponseEntity<CustomerErrorResponse> handleException(CustomerNotFoundException e){
		
		//ceate Customererror responce
	...
	//add another exception handler  .. to try catch aany exception (catch all)
	@ExceptionHandler
